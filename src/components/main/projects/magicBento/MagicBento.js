...
const cardData = [
...

  {
    ...
    title: "",
    description: "",
    label: "Z-Fashion by Css",
    link: "https://ahmedkhld99.github.io/Z-Fashion/",
  },
  {
    color: "#060010e0",
    title: "",
    description: "",
    label: "Jorum. by Css",
    link: "https://ahmedkhld99.github.io/restaurant-project/",
  },
];
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          ...
          return (
            <ParticleCard
              key={index}
              className={`${baseClassName} ${bgClass} ${`custom-el`}`}
